const { readData, writeData, toCamelCase } = require('../utils/Util');
...
class Service {
    ...
    insert(entity, id, callback = undefined) {
        ...
        return `${this.ENTITY_NAME} was added`;
    };
    ...
    update(entity, id, callback = undefined) {
        ...
        writeData(this.fileName, this.entities);
        if (callback) callback(entity);
        return `${this.ENTITY_NAME} was updated`;
    };
    ...
    delete(id, callback = undefined) {
        ...
        writeData(this.fileName, this.entities);
        if (callback) callback(entity);
        return `${this.ENTITY_NAME} was deleted`;
    };
